package com.songjachin.allskillinandroid.remote.service;
...
public class RemoteService extends Service {
    ...
    private final IRemoteService.Stub mBinder = new IRemoteService.Stub() {
        ...
        @Override
        public void setMyData(MyData data) throws RemoteException {
            mMyData.setData1(data.getData1());
            mMyData.setData2(data.getData2());
            Log.i(TAG,"[RemoteService] setMyData() "+ mMyData.toString());
        }
